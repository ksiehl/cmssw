...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:output/output-reco.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('output-miniaod.root'),
...
process.schedule = cms.Schedule(process.Flag_CSCTightHaloFilter,process.Flag_CSCTightHaloTrkMuUnvetoFilter,process.Flag_CSCTightHalo2015Filter,process.Flag_globalTightHalo2016Filter,process.Flag_globalSuperTightHalo2016Filter,process.Flag_HcalStripHaloFilter,process.Flag_hcalLaserEventFilter,process.endjob_step,process.MINIAODSIMoutput_step)
