...
process.ana = cms.EDAnalyzer('B2GTTbarTreeMaker',
    ...
    triggerBits   = cms.InputTag("TriggerResults", "", "HLT"), #NOTE:CHANGING HLT2 TO HLT
...
process.out = cms.OutputModule(
     ...
     fileName = cms.untracked.string('combine1.root'),
...
process.TFileService = cms.Service("TFileService",
      ...
      fileName = cms.string('combine2.root'),
      outputCommands = cms.untracked.vstring("keep *_allWeights_*_*"),
